            ...
            VStack{
                if self.status{
                    ...
                    ZStack{
                        ...
                        NavigationLink(destination: SignUp(show: self.$show), isActive: self.$show, label: {
                            Text("")
                        })
                        .hidden()
            ...
            ZStack(alignment: .topTrailing, content: {
                GeometryReader{_ in
                    ...
                    VStack{
                        ...
                        .padding()
                        .background(RoundedRectangle(cornerRadius: 4)
                            .stroke(self.pass != "" ? Color("Color") : self.color, lineWidth: 2))
                        .padding(.top, 25)
            ...
            ZStack(alignment: .topLeading, content: {
                GeometryReader{_ in
                    ...
                    VStack{
                        ...
                        Text("Fill in the blanks to register")
                            .font(.title)
                            .fontWeight(.bold)
                            .foregroundColor(self.color)
                            .padding(.top, 35)
        ...
        GeometryReader{_ in
            ...
            VStack{
                ...
                HStack{
                    ...
                    Text(self.error == "RESET" ? "Message" : "Some error")
                        .font(.title)
                        .fontWeight(.bold)
                        .foregroundColor(self.color)
